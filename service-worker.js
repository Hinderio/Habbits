...
const SQL_ASSETS = ['./sql/add-dossiers.sql', './sql/add-appointment-series.sql', './sql/add-projects.sql', './sql/add-task-steps.sql', './sql/add-alcohol-daily-intensity.sql'];
