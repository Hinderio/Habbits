const CACHE_NAME = 'habitflow-v157-project-touch-open';
const MODULE_ASSETS = [
...
const NETWORK_FIRST_PATHS = new Set(['/', '/index.html', '/app.js', '/style.css', '/app.js', './supabase-config.js', './supabase-schema.js', './manifest.json', './sql/add-projects.sql', ...MODULE_ASSETS.map(path => path.replace(/^\./, ''))]);
